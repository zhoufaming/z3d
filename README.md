...
这个工具从开始写第一行解析代码，到圆角热床、多盘仿真、布尔修复、AI 辅助控制，再到桌面套壳，花了不少周末和夜晚。如果你觉得它帮到了你，欢迎请我喝杯咖啡 —— 你的支持会让我有更多动力继续完善它。

<p align="center">
  <img src="docs/images/wechat-donate.jpg" width="360" alt="微信赞赏码">
</p>
...
**非商业用途许可（Non-Commercial License）**

本软件以「原样」提供，仅供个人学习、研究与非商业用途。在未经作者书面授权的情况下，**禁止将本软件及其衍生作品用于任何商业目的**，包括但不限于：售卖、用于付费服务、嵌入商业产品、以盈利为目的的再分发等。

如需商业使用，请通过微信赞赏码联系作者协商授权。
